...
class aos_mb_bar_04_: UIView {
    ...
    func setDataMinus() {
        ...
        chartItems.append(BarChartItemData(title: "최대글자", valueTitle: "", value: 213, barVisual: barVisual))
        chartItems.append(BarChartItemData(title: "9월",  valueTitle: "", value: 365, barVisual: barVisual))
        barChartView.setChartItems(items: chartItems)
    }
}
