...
//        barChartView.setHeight(250)
        ...
        barChartView.chartView.leftAxis.isForceEntriesEnable = true
        ...
        chartItems.append(StackBarChartItemData(stackItems: [StactBarItem(color: #colorLiteral(red: 0.05882352963, green: 0.180392161, blue: 0.2470588237, alpha: 1), value: 21.3), StactBarItem(color: #colorLiteral(red: 0.3098039329, green: 0.01568627544, blue: 0.1294117719, alpha: 1), value: 16.0), StactBarItem(color: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), value: 7.0)], title: "외상매출", valueTitle: "22.3억", value: 12.3, barVisual: barVisual))
